...
enum class APIError(val httpStatus: HttpStatus, val code: Int, val message: String) {
    VALIDATION_ERROR(HttpStatus.BAD_REQUEST, 400_07_01, "The are attributes with wrong values"),
    BAD_FORMAT(HttpStatus.BAD_REQUEST, 400_07_02, "The message does not have a correct formatq"),
